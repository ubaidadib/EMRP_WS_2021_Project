...
\\
{{:emrp2021:node-red-example-article-hello-world_1.png?400|}}\\
|//Figure 4: Node-Red //|
\\
...
{{:emrp2021:sensors_microcont.png?400|}}
| //Figure 5: Hardware//  |
...
| {{:emrp2021:ttn_add_application.png?600}}  |
...
{{:emrp2021:ttn_application_details.png?600|}}
...
{{:emrp2021:ttn_add_end_device.png?600|}}
...
{{:emrp2021:ttn_big_little_endian.png?600|}}
...
{{:emrp2021:database_config.png?600|}}
...
{{:emrp2021:get_dist_get_temp.png?800|}}
...
{{:emrp2021:more_than_one_gw.png?600|}}
| //Figure 26: Function node to handle more than one gateway//  |

{{:emrp2021:more_than_one_gw_func.png?600|}}
...
{{:emrp2021:split.png?600|}}
| //Figure 28:split node//  |

{{:emrp2021:split_properties.png?600|}}
...
{{:emrp2021:get_connection_data_db.png?600|}}
...
{{:emrp2021:join_properties.png?600|}}
...
{{:emrp2021:store_connection_data_multiple_gw.png?600|}}
...
{{:emrp2021:connection_parameters.png?600|}}
...
{{:emrp2021:username_password_node_red.png?600|}}
...
{{:emrp2021:ta_measurement.png?600|}}
...
{{:emrp2021:ta_connection.png?600|}}
...
{{:emrp2021:dashplotly001.png?600|}}
...
{{:emrp2021:active_sensors.png?400|}}
...
{{:emrp2021:database_connection.png?400|}}
...
{{:emrp2021:functions001.png?400|}}
| // Figure 56: Queries Part 1 // | 

{{:emrp2021:functions002.png?400}}
